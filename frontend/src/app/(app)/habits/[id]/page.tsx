    ...
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <button
          ...
          className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors cursor-pointer mb-6 group focus:outline-none focus-visible:ring-2 focus-visible:ring-[#FF8243] rounded-lg"
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-gray-400 text-sm">Loading habit...</p>
          </div>
        )}
        ...
        {!loading && fetchError && (
          <div className="py-12 text-center">
            ...
            <button
              onClick={() => router.push('/habits')}
              className="text-[#069494] hover:underline text-sm cursor-pointer"
            >
              Go back to habits
            </button>
          </div>
          ...
          >
            ...
            <div className="p-5 rounded-2xl bg-gray-900 border border-gray-800">
              ...
              <div className="mt-4 flex flex-wrap gap-2 text-xs">
                ...
                <span className="px-2 py-1 rounded-full bg-[#FCE883]/10 text-[#FCE883]">
                  {habit.points} pts
                </span>
                {habit.completed_today && (
                  <span className="px-2 py-1 rounded-full bg-[#FF8243]/10 text-[#FF8243] font-medium">
                    Completed today
                  </span>
                )}
              </div>
            ...
            {/* Delete section */}
            <div className="p-5 rounded-2xl bg-gray-900 border border-red-900/30">
              ...
              <AnimatePresence mode="wait">
                {!showDeleteConfirm ? (
                  <motion.button
                    ...
                    className="px-4 py-2 rounded-lg text-sm font-medium text-red-400 border border-red-500/30 hover:bg-red-500/10 transition-colors cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400"
                  >
                    Delete this habit
                  </motion.button>
                ) : (
                  ...
                  >
                    <p className="text-sm text-red-300 mr-auto">Are you sure?</p>
                    <button
                    ...
                    <button
                      ...
                      disabled={isDeleting}
                      className="px-3 py-1.5 rounded-lg text-xs font-medium text-white bg-red-500 hover:bg-red-600 transition-colors cursor-pointer disabled:opacity-50"
                    >
